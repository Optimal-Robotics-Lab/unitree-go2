...
class UnitreeGo2Env(PipelineEnv):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.feet_linear_acceleration_seonsor = [
            "fr_global_linacc",
            "fl_global_linacc",
            "hr_global_linacc",
            "hl_global_linacc",
    ...
    def step(self, state: State, action: jax.Array) -> State:  # pytype: disable=signature-mismatch
        ...
        rewards = {
            'tracking_pose': (
                self._reward_tracking_pose(imu_height)
            ),
            ...
            'foot_acceleration': self._reward_foot_acceleration(pipeline_state),
        }
        rewards = {
