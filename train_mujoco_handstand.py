...
from training.envs.unitree_go2_mujoco_handstand import unitree_go2_handstand
from training.envs.unitree_go2_mujoco_handstand import config
from training.envs.unitree_go2_mujoco_handstand import randomize
...
def main(argv=None):
    ...
    eval_env = unitree_go2_handstand.UnitreeGo2Env(
        env_config=env_config,
        reward_config=reward_config,
        noise_config=noise_config,
        disturbance_config=disturbance_config,
